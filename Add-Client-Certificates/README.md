<p>This plugin allows you to register a client certificate with a player. Once registered, the certificate can be used when displaying remote HTML webpages.</p>
